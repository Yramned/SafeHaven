<?php
/**
 * SafeHaven - Evacuation Request View (User)
 * Pure view: $csrfToken provided by EvacuationController::requestForm()
 */
?>
...
<form id="evacuationFormScreen" class="evac-form-screen"
      method="post" action="<?= BASE_URL ?>index.php?page=evacuation-request-submit">

    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken, ENT_QUOTES, 'UTF-8') ?>">

    <!-- Location -->
    <div class="sh-card loc-card">
...
<div id="evacuationSuccessScreen" class="success-screen">
    ...
    <div class="sh-card success-hero">
    ...
    <div class="sh-card assigned-card">
    ...
    <!-- Confirmation code -->
    <div class="sh-card conf-code-box">
    ...
    <!-- Capacity bar -->
    <div class="sh-card capacity-box">
    ...
    <div class="action-btns">
        <button class="btn-directions" type="button" id="btnDirections" data-lat="" data-lng="">Get Directions</button>
        <a class="btn-call" id="btnCall" href="#">Call Center</a>
    </div>
