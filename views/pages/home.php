...
<section class="hero" id="hero">
    <div class="hero-wrap">
        ...
        <div class="hero-btns">
            <a href="<?= BASE_URL ?>index.php?page=register" class="btn-hero-primary">Get Started</a>
    ...
    <div class="container">
        ...
        <div class="contact-layout">
            ...
            <div class="contact-form-box reveal">
                ...
                <form action="<?= BASE_URL ?>index.php?page=contact-submit" method="POST">
                    <div class="form-row">
                        <label>Name</label>
            ...
            <div class="contact-info reveal">
                ...
                <div class="info-row">
                    ...
                    <div>
                        ...
                        <span class="info-value"><?= CONTACT_WEBSITE ?></span>
                    </div>
                </div>
            </div>
        </div>
